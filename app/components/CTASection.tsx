  ...
  return (
    <section id="contacto" className="relative py-24 md:py-32 bg-[var(--color-brand-dark)]">
      <div className="absolute inset-0 z-0">
        <Image
          src="/images/instalaciones-planta-cmp-sas.webp"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-8 max-w-3xl mx-auto mb-12">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            ...
            className="bg-[#25D366] hover:bg-[#20BE5C] text-white px-8 py-4 rounded-xl font-bold transition-all duration-300 flex items-center justify-center gap-2 text-lg"
          >
          ...
          <a
            ...
            className="text-gray-400 hover:text-white border border-white/10 px-8 py-4 rounded-xl font-medium transition-all duration-300 text-lg"
          >
            +57 313 780 4820
          </a>
        </div>
